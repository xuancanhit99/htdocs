              ...
              <ul class="nav navbar-nav">
			   <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                       <li> <a  href="admin.php" > &nbsp;&nbsp; Employee</a></li>
...
<?php	include('modal.php'); ?>
 ...
 <form method="POST" action="E_D_dept.php" >
  <div class="form-group">
 <div class="row">
  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            <div class="alert alert-info">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong><i class="icon-user icon-large"></i><center>&nbsp;Department List</center></strong>
                            </div>
                            <thead>
                                <tr>
	...
	?>
	 ...
	 <td><a href="E_D_dept.php <?php  echo '?sal='.$id;?>	 "><?php  echo $show['dep_name'];  ?></a></td>
