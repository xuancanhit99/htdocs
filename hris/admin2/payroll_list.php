...
<?php	include('modal.php'); ?>
  ...
  <div style="overflow:scroll; height:auto ; width:1200px;">
   ...
   <div class="alert alert-info">
                                ...
                                <strong><i class="icon-user icon-large"></i><center>&nbsp;Payroll of <?php echo $month; ?> in <?php echo $year; ?></center></strong>
                            </div>    
				  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
				  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
				  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
	...
	*/
		$gp=(" select * from general_payroll where month='$month' and year='$year'  ") ;
		$emp=$mysqli->query($gp);
...
<td><center> <a href="E_D_pay.php<?php echo '?emp='.$id;?>"><?php  echo $show['net_amt'];  ?> </a></center></td>
	...
	<div class="row">
	 ...
	 <INPUT TYPE="hidden" name="year" value="<?php echo $year ?> "> 
				  &nbsp; <button type="submit" class="btn btn-info btn-sm"> &nbsp;<i class="glyphicon glyphicon-log-out"></i>&nbsp;	 Print </button>
				  </form>
</div>
