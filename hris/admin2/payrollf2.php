...
hdmf_pre,sos_ecard_plus,uoli_educ,ceap_pre_need,ucpb_loan,assoc_dues_coop,integ_mngt_ser,net_amt,month,year)  

     values('$name','$gross_income','$earned_period','$csb_loan','$pvb_loan','$w_holding','$ret_ins','$salary_loan','$policy_loan','$med','$hdmf_pre',
	 '$sos_ecard_plus','$uoli_educ','$ceap_pre_need', '$ucpb_loan','$assoc_dues_coop','$integ_mngt_ser','$net_amt','$month','$year')");
$mysqli->Query($query);	
