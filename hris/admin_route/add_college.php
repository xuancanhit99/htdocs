...
$emp=(" insert into college(employee_id,school_name,degree_course,year_graduated,highest_grade_level_units_earned,dates_from,dates_to,scholar_academic_honors)  
