...
//personal info
 $vocational_trade_course_id=$_POST['vocational_trade_course_id'];
...
$up_emp=("update vocational_trade_course set 
 degree_course='$degree_course',
 ...
 where  vocational_trade_course_id='$vocational_trade_course_id' ");
