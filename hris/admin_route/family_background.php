...
<body>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
						...
						<?php	$id=$_GET['id'];
                            ...
                            <li>
                                <a href="personal_info.php?">I.Personal Information</a>
                            </li>
                            <li>
                                <a href="family_background.php">II.Family Background</a>
                            </li>
							       <li>
                                <a href="Educational_Background.php">III.Educational Background</a>
                            </li>
							       <li>
                                <a href="civil_service.php">IV.Civil Service</a>
                            </li>
							       <li>
                                <a href="work_experience.php">V.Work Experience</a>
                            </li>
							       <li>
                                <a href="voluntary_work.php">VI.Voluntary Work</a>
                            </li>
							       <li>
                                <a href="training_programs.php">VII.Training Programs</a>
                            </li>
							       <li>
                                <a href="other_information.php">VIII.Other Information</a>
                            </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">II.Family Background</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
